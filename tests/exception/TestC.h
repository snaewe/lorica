...
#if !defined (_TEST_BOBO_CH_)
#define _TEST_BOBO_CH_
  
  class  bobo : public ::CORBA::UserException
  {
  public:
    ...
    bobo &operator= (const bobo &);
    
    static bobo *_downcast ( ::CORBA::Exception *);
    static const bobo *_downcast ( ::CORBA::Exception const *);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::bobo &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::bobo &);
