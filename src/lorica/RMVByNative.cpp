...
bool
Lorica::RMVByNative::bind(CORBA::Object_ptr key,
...
bool
Lorica::RMVByNative::rebind(CORBA::Object_ptr key,
			    ReferenceMapValue *value)
{
	value->incr_refcount();
...
bool
Lorica::RMVByNative::find(CORBA::Object_ptr key,
			  ReferenceMapValue *&value)
{
...
bool
Lorica::RMVByNative::unbind(CORBA::Object_ptr key,
			    ReferenceMapValue *& value)
{
...
int
Lorica::RMVByNative::ObjRefLessThan::operator()	(const CORBA::Object_ptr lhs,
