...
#  did just test an option to be possibly added. However, some compilers accept 
#  an option silently, or possibly for just another option that was not intended. 
#  Therefore, we have to do a generic test for a compiler family. For gcc we 
#  check "-pedantic" being accepted which is also understood by compilers who 
#  just want to be compatible with gcc even when not being made from gcc sources.
#
